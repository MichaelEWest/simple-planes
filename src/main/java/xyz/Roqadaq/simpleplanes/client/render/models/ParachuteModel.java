...
import xyz.przemyk.simpleplanes.client.render.ParachuteRenderState;

public class ParachuteModel extends EntityModel<ParachuteRenderState> {
	...
	@Override
	public void setupAnim(ParachuteRenderState state) {}
}