...
import xyz.roqadaq.simpleplanes.client.render.ParachuteRenderer;
import xyz.roqadaq.simpleplanes.client.render.PlaneRenderer;
import xyz.roqadaq.simpleplanes.client.render.UpgradesModels;
import xyz.roqadaq.simpleplanes.client.render.models.*;
import xyz.roqadaq.simpleplanes.setup.SimplePlanesEntities;
import xyz.roqadaq.simpleplanes.setup.SimplePlanesUpgrades;
import xyz.roqadaq.simpleplanes.upgrades.armor.*;
import xyz.roqadaq.simpleplanes.upgrades.booster.BoosterModel;
import xyz.roqadaq.simpleplanes.upgrades.booster.CargoBoosterModel;
import xyz.roqadaq.simpleplanes.upgrades.booster.HeliBoosterModel;
import xyz.roqadaq.simpleplanes.upgrades.booster.LargeBoosterModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.electric.CargoElectricEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.electric.ElectricEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.electric.HeliElectricEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.electric.LargeElectricEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.furnace.CargoFurnaceEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.furnace.FurnaceEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.furnace.HeliFurnaceEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.furnace.LargeFurnaceEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.liquid.CargoLiquidEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.liquid.HeliLiquidEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.liquid.LargeLiquidEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.engines.liquid.LiquidEngineModel;
import xyz.roqadaq.simpleplanes.upgrades.floating.*;
import xyz.roqadaq.simpleplanes.upgrades.seats.*;
import xyz.roqadaq.simpleplanes.upgrades.shooter.HeliShooterModel;
import xyz.roqadaq.simpleplanes.upgrades.shooter.LargeShooterModel;
import xyz.roqadaq.simpleplanes.upgrades.shooter.ShooterModel;
import xyz.roqadaq.simpleplanes.upgrades.solarpanel.CargoSolarPanelModel;
import xyz.roqadaq.simpleplanes.upgrades.solarpanel.LargeSolarPanelModel;
import xyz.roqadaq.simpleplanes.upgrades.solarpanel.SolarPanelModel;
...
public class PlanesModelLayers {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        event.registerEntityRenderer(SimplePlanesEntities.PLANE.get(), context -> new PlaneRenderer<>(context, new PlaneModel(context.bakeLayer(PlanesModelLayers.PLANE_LAYER)), new PlaneMetalModel(context.bakeLayer(PLANE_METAL_LAYER)), new PropellerModel(context.bakeLayer(PlanesModelLayers.PROPELLER_LAYER)), 0.6f, Identifier.fromNamespaceAndPath(SimplePlanesMod.MODID, "textures/plane_upgrades/plane_metal.png"), Identifier.fromNamespaceAndPath(SimplePlanesMod.MODID, "textures/plane_upgrades/iron_propeller.png")));
        event.registerEntityRenderer(SimplePlanesEntities.LARGE_PLANE.get(), context -> new PlaneRenderer<>(context, new LargePlaneModel(context.bakeLayer(PlanesModelLayers.LARGE_PLANE_LAYER)), new LargePlaneMetalModel(context.bakeLayer(LARGE_PLANE_METAL_LAYER)), new LargePropellerModel(context.bakeLayer(PlanesModelLayers.LARGE_PROPELLER_LAYER)), 1.0f, Identifier.fromNamespaceAndPath(SimplePlanesMod.MODID, "textures/plane_upgrades/large_plane_metal.png"), Identifier.fromNamespaceAndPath(SimplePlanesMod.MODID, "textures/plane_upgrades/iron_large_propeller.png")));
        event.registerEntityRenderer(SimplePlanesEntities.CARGO_PLANE.get(), context -> new PlaneRenderer<>(context, new CargoPlaneModel(context.bakeLayer(PlanesModelLayers.CARGO_PLANE_LAYER)), new CargoPlaneMetalModel(context.bakeLayer(CARGO_PLANE_METAL_LAYER)), new CargoPropellerModel(context.bakeLayer(PlanesModelLayers.CARGO_PROPELLER_LAYER)), 1.0f, Identifier.fromNamespaceAndPath(SimplePlanesMod.MODID, "textures/plane_upgrades/cargo_plane_metal.png"), Identifier.fromNamespaceAndPath(SimplePlanesMod.MODID, "textures/plane_upgrades/iron_cargo_propeller.png")));
        event.registerEntityRenderer(SimplePlanesEntities.HELICOPTER.get(), context -> new PlaneRenderer<>(context, new HelicopterModel(context.bakeLayer(PlanesModelLayers.HELICOPTER_LAYER)), new HelicopterMetalModel(context.bakeLayer(HELICOPTER_METAL_LAYER)), new HelicopterPropellerModel(context.bakeLayer(PlanesModelLayers.HELICOPTER_PROPELLER_LAYER)), 0.6f, Identifier.fromNamespaceAndPath(SimplePlanesMod.MODID, "textures/plane_upgrades/helicopter_metal.png"), Identifier.fromNamespaceAndPath(SimplePlanesMod.MODID, "textures/plane_upgrades/iron_helicopter_propeller.png")));

        event.registerEntityRenderer(SimplePlanesEntities.PARACHUTE.get(), context -> new ParachuteRenderer(context, new ParachuteModel(context.bakeLayer(PlanesModelLayers.PARACHUTE_LAYER))));
}
    @SubscribeEvent
