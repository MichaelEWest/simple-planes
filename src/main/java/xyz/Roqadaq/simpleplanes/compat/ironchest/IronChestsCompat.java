...
public class IronChestsCompat {
    ...
    public static final Identifier IRON_CHEST_GUI = Identifier.fromNamespaceAndPath(MODID, "textures/gui/iron_container.png");
    public static final Identifier GOLD_CHEST_GUI = Identifier.fromNamespaceAndPath(MODID, "textures/gui/gold_container.png");
    public static final Identifier DIAMOND_CHEST_GUI = Identifier.fromNamespaceAndPath(MODID, "textures/gui/diamond_container.png");
    public static final Identifier COPPER_CHEST_GUI = Identifier.fromNamespaceAndPath(MODID, "textures/gui/copper_container.png");
    public static final Identifier SILVER_CHEST_GUI = Identifier.fromNamespaceAndPath(MODID, "textures/gui/silver_container.png");
    public static final Identifier DIRT_CHEST_GUI = Identifier.fromNamespaceAndPath(MODID, "textures/gui/dirt_container.png");
    public static final Identifier VANILLA_CHEST_GUI = Identifier.fromNamespaceAndPath(SimplePlanesMod.MODID, "textures/gui/vanilla_chest.png");
    ...
    public static void registerUpgradeItems() {
        registerChest(BuiltInRegistries.ITEM.getOptional(Identifier.fromNamespaceAndPath("ironchest", "iron_chest")).orElse(null));
        registerChest(BuiltInRegistries.ITEM.getOptional(Identifier.fromNamespaceAndPath("ironchest", "gold_chest")).orElse(null));
        registerChest(BuiltInRegistries.ITEM.getOptional(Identifier.fromNamespaceAndPath("ironchest", "diamond_chest")).orElse(null));
        registerChest(BuiltInRegistries.ITEM.getOptional(Identifier.fromNamespaceAndPath("ironchest", "copper_chest")).orElse(null));
        registerChest(BuiltInRegistries.ITEM.getOptional(Identifier.fromNamespaceAndPath("ironchest", "silver_chest")).orElse(null));
        registerChest(BuiltInRegistries.ITEM.getOptional(Identifier.fromNamespaceAndPath("ironchest", "crystal_chest")).orElse(null));
        registerChest(BuiltInRegistries.ITEM.getOptional(Identifier.fromNamespaceAndPath("ironchest", "obsidian_chest")).orElse(null));
        registerChest(BuiltInRegistries.ITEM.getOptional(Identifier.fromNamespaceAndPath("ironchest", "dirt_chest")).orElse(null));
    }
